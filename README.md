...
<img src="public\images\screenshot-1.jpg" alt="screenshot of the example app" width="100%" />
...
But for this NodeJs website example, you can choose GitHub as your deployment method.

### Step 3: Authentication

If you forked the repo then you can click on the sign-in with GitHub button and authorize elestio to access the git repo then you can select the Nodejs-example repo otherwise you can directly insert a git repo URL to deploy the NodeJs website.
